...
class ACLWcShortcodes {
    public static function init() {
        ...
        add_action( 'woocommerce_session_init', array( 'ACLWcShortcodes\ACLWCRFQCart\ACL_WC_RFQ_cart','acl_restore_rfq_login' ) );
        ...
        add_action( 'woocommerce_add_to_cart', array( 'ACLWcShortcodes\ACLWCRFQCart\ACL_WC_RFQ_cart', 'acl_save_rfq_cart_to_user_meta' ) );
        add_action( 'woocommerce_cart_item_removed', array( 'ACLWcShortcodes\ACLWCRFQCart\ACL_WC_RFQ_cart', 'acl_save_rfq_cart_to_user_meta' ) );
        add_action( 'woocommerce_cart_item_restored', array( 'ACLWcShortcodes\ACLWCRFQCart\ACL_WC_RFQ_cart', 'acl_save_rfq_cart_to_user_meta' ) );
        add_action( 'woocommerce_cart_item_set_quantity', array( 'ACLWcShortcodes\ACLWCRFQCart\ACL_WC_RFQ_cart', 'acl_save_rfq_cart_to_user_meta' ) );
