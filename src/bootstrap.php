...
class ACLWcShortcodes {
    public static function init() {
        ...
        add_action( 'acl_woocommerce_after_cart', array ( 'ACLWcShortcodes\ACLWCRFQCheckout\ACL_WC_RFQ_checkout', 'acl_display_quote_form' ) ); 
        ...
        //add_filter( 'woocommerce_product_add_to_cart_text', array( 'ACLWcShortcodes\Helpers\ACL_WC_Helpers', 'acl_custom_add_to_cart_text', 10 ) );
