                            ...
                            <td class="product-details" data-title="<?php esc_attr_e( 'Deails', 'woocommerce' ); ?>">
                                ...
                                ?>
                                    <div class="product-details">
                                        <textarea id="product-deets-<?php echo esc_attr( $product_id ); ?>" name="product-deets[<?php echo esc_attr( $product_id ); ?>]" class="input-text" rows="2"><?php echo isset( $quote_cart[$product_id]['product-deets'] ) ? esc_textarea( $quote_cart[$product_id]['product-deets'] ) : ''; ?></textarea>
                                    </div>
                                <?php
                                }
                                ?>
